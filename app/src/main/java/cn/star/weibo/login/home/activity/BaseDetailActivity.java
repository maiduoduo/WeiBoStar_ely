...
import cn.star.weibo.login.home.adapter.HeaderAndFooterRecyclerViewAdapter;
import cn.star.weibo.login.home.adapter.MentionDetailAdapter;
import cn.star.weibo.login.home.widget.OnDetailButtonClickListener;
import cn.star.weibo.mvp.model.iml.StatusDetailModelImp;
import cn.star.weibo.mvp.presenter.DetailActivityPresent;
import cn.star.weibo.mvp.presenter.iml.DetailActivityPresentImp;
import cn.star.weibo.mvp.view.DetailActivityView;
import cn.star.weibo.utils.RecyclerViewStateUtils;
import cn.star.weibo.utils.ToastUtil;
import cn.star.weibo.view.widget.EndlessRecyclerOnScrollListener;
import cn.star.weibo.view.widget.load.LoadingFooter;


/**
 * Created by dash on 16/4/20.
 */
public abstract class BaseDetailActivity extends LoginBaseActivity implements DetailActivityView {

...
import cn.star.weibo.base.BasePopupWindow;
import cn.star.weibo.utils.SaveImgUtil;
...
/**
 * User: dcl
 * Method/Class Name:ImageOptionPopupWindow
 * Date: 2016-12-07
 * About:加载微博列表图片的配置
 * param:
 * FIXME
...
public class ImageOptionPopupWindow extends BasePopupWindow{
    ...
    public ImageOptionPopupWindow(Context context, Activity activity, long animatorduration) {
        super(context, activity, animatorduration);
    }

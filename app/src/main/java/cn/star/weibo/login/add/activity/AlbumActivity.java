...
import cn.star.weibo.login.add.adapter.GirdViewAdapter;
import cn.star.weibo.login.add.bean.AlbumFolderInfo;
import cn.star.weibo.login.add.popmenu.ImgFolderPopWindow;
import cn.star.weibo.login.add.utils.ImageScan;
import cn.star.weibo.login.home.bean.ImageInfoBean;
import cn.star.weibo.utils.ScreenUtil;

/**
 * User: dcl
 * Method/Class Name:AlbumActivity
 * Date: 2016-12-14
 * About:发表图片/视频界面
 * param:
 * FIXME
...
public class AlbumActivity extends LoginBaseActivity implements ImgFolderPopWindow.OnFolderClickListener, GirdViewAdapter.OnImgSelectListener {

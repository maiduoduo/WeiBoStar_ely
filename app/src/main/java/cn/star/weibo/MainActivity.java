...
import cn.star.weibo.login.add.activity.AddActivity;
import cn.star.weibo.login.find.fragment.FindFragment;
import cn.star.weibo.login.home.fragment.HomeFragment;
import cn.star.weibo.login.message.fragment.MessageFragment;
import cn.star.weibo.login.mine.fragment.MineFragment;
...
public class MainActivity extends AppCompatActivity {
     ...
     * 关于我fragment
     */
    private MineFragment mProfileFragment;
    ...
    private void restoreFragment(Bundle savedInstanceState) {
        ...
        mDiscoverFragment = (FindFragment) mFragmentManager.findFragmentByTag(DISCOVERY_FRAGMENT);
        mProfileFragment = (MineFragment) mFragmentManager.findFragmentByTag(PROFILE_FRAGMENT);

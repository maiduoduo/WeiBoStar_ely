...
public class TitleBar extends RelativeLayout {
	...
	private void initView() {
		...
		View view = inflater.inflate(R.layout.activity_title, this);
		titleTextView = (TextView) view.findViewById(R.id.home_title_textview);
		backImageView = (ImageView) view.findViewById(R.id.title_back_imageview);
